...
interface Noti {
    ...
    progressColourStart?: string;
    progressColourEnd?: string;
    type?: 'success' | 'error' | 'warning';   // TODO: Display a logo for common notification types.
}
...
function demo() {
    ...
    function getPastelColour(): string {
